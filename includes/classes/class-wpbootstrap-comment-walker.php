<?php
/**
 * A custom WordPress comment walker class to implement the
 * Bootstrap 3 Media object in WordPress comment list.
 *
 * @package    WPBootstrap
 * @subpackage Core
 * @since      1.0.0
...
/**
 * Class WPBootstrap_Comment_Walker
 */
class WPBootstrap_Comment_Walker extends Walker_Comment {
				...
				<span class="comment-metadata pull-right">
                    <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID, $args ) ); ?>">
                        <time datetime="<?php comment_time( 'c' ); ?>">
                            <?php printf( _x( '%1$s at %2$s', '1: date, 2: time' ), get_comment_date(),
	                            get_comment_time() ); ?>
                        </time>
                    </a>
