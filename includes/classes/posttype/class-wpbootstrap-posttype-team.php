...
/**
 * Class WPBootstrap_Post_Type_Team
 */
class WPBootstrap_PostType_Team {
	 ...
	 * @var string
	 */
	private static $post_type = 'wpb-team';
	 ...
	 * @var string
	 */
	private static $post_type_public_name = 'Team';
	 ...
	 * @var string
	 */
	private static $post_type_singular_name = 'Team';
	 ...
	 * @var string
	 */
	private static $post_type_plural_name = 'Teams';
	 ...
	 * @var string
	 */
	private static $post_type_rewrite_slug = 'team';
	...
	/**
	 * Initialize Team custom post type.
	 *
	 * @static
	 * @access public
	 * @since  1.0.0
	...
	/**
	 * Register custom post type called Team.
	 *
	 * @static
	 * @access public
	 * @since  1.0.0
