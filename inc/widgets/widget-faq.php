<?php
/**
 * Widget API: WP_Bootstrap_Widget_FAQ class
 *
 * @package    WordPress
 * @subpackage Widgets
 * @since      4.4.0
 ...
 * @see   WP_Widget
 */
class WP_Bootstrap_Widget_FAQ extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        $title     = apply_filters( 'widget_title',
            empty( $instance['title'] ) ? __( 'FAQ' ) : $instance['title'],
...
/**
 * Register WP_Bootstrap_Widget_FAQ widget.
 */
function wp_bootstrap_register_faq_widget() {
    register_widget( 'WP_Bootstrap_Widget_FAQ' );
    do_action( 'widgets_init' );
}

add_action( 'init', 'wp_bootstrap_register_faq_widget' );
