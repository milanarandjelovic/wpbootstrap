<?php
/**
 * Template for display comment form.
 *
 * @package    WPBootstrap
...
$non_register_comments_fields = array(
	'author' => '<div class="form-group">
					...
					<input id="author" name="author" class="form-control" placeholder="your name" type="text" 
	...
	'email'  => '<div class="form-group">
					...
					<input id="email" class="form-control" name="email" placeholder="email@address.co.uk" type="email" value="' .
...
$comments_args = array(
	...
	'title_reply_to'      => esc_html__( 'Leave a Reply to Comment', 'wp_bootstrap' ),
